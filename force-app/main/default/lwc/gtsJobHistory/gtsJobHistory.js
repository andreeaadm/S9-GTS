...
import getJobTimeStampsApex from '@salesforce/apex/GTSJobHistoryController.getTimeStamps';

export default class GtsJobHistory extends LightningElement {
    @api recordId;
    @track jobTimestamps;

    columns = [
        { label: HISTORICAL_STATUS, fieldName: 'status', hideDefaultActions:"true"},
        { label: DATE_AND_TIME_LABEL, fieldName: 'timeStampDate', type: 'date', hideDefaultActions:"false",
            typeAttributes: {
                day: "numeric",
                month: "numeric",
                year: "numeric",
